...
#ifndef object_recognition_OBJECT_RECOGNIZER_H
#define object_recognition_OBJECT_RECOGNIZER_H

#include <pcl_recognition.h>
...
private:
    ...
    //pcl::PCLPointCloud2ConstPtr& cloud_msg;
    ...
    ros::Publisher objectRT_publisher_;
...
#endif //object_recognition_OBJECT_RECOGNIZER_H
